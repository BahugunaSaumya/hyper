...
export default function LoginPage() {
  ...
  // simple auto-rotate for the left hero
  useEffect(() => {
        ...
        <section className="px-6 sm:px-10 lg:px-14 py-12 lg:py-20">
          <div className="mx-auto w-full max-w-lg">
            ...
            <div className="mt-2 text-right">
              <a href="/reset-password" className="text-xs text-pink-500 hover:underline">
                Reset Password
              </a>
            </div>
            ...
            <button
              ...
              disabled={loading}
              className="mt-7 w-full py-3 rounded-full border-2 border-black font-semibold hover:bg-black hover:text-white transition disabled:opacity-60 disabled:cursor-not-allowed"
            >
